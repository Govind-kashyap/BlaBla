...
function Register() {
    ...
    return (
        // <div className="flex flex-col justify-center items-center w-full h-screen gap-10 bg-[#001529] text-white font-bold">
        // <Button onClick={() => navigate("/")}>Dashboard</Button>

        // <div className="flex flex-col justify-center gap-6 p-20 bg-white rounded-xl w-[35vw] h-[80vh]">
